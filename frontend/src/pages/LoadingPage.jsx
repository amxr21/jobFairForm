...
const LoadingPage = () => {
    return (
        <div id="LoadingPage" className="fixed inset-0 z-[99999999] flex items-center justify-center p-4 bg-white/70 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                {/* Green header band */}
