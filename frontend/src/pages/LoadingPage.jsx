...
const LoadingPage = () => {
    return (
        <div id="LoadingPage" className="fixed top-0 left-0 w-full h-full z-[99999999] p-3 md:p-10">
            <div className="flex md:flex-row flex-col gap-6 w-full h-full bg-white opacity-95 border rounded-[2rem] p-16 items-center justify-center">
