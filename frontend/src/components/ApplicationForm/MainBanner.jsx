...
const MainBanner = () => {
    ...
    return (
        <div id="Hero" className="md:w-8/12 md:mx-auto my-2 md:my-20 md:my-12 py-12 h-fit overflow-hidden">
            <div className="md:text-2xl md:text-left text-center mb-4">
                <h2 className="md:text-6xl text-7xl font-bold mb-4 md:mb-2">Hala Wallah</h2>
