...
const Language = ({lang}) => {
    ...
    return (
        <div className="checkbox h-5 flex items-center md:me-14">
            <input  ref={refLabel} onChange={getLang} type="checkbox" name={lang} id={lang} className="md:min-w-2 lg:min-w-3 xl:min-w-4  xl:min-h-4 me-2 z-50 accent-[#0E7F41]"/>
