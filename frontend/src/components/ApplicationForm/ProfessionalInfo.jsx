                        ...
                        <div className="col-span-12 md:col-span-7">
                            <div className="flex flex-col h-full">
                                ...
                                <textarea
                                    ...
                                    className={`flex-1 w-full bg-surface-field border border-line-strong rounded-md py-1 px-2 text-xs md:text-sm resize-none min-h-16 md:min-h-20 ${noExperience ? 'bg-surface-hover text-fg-faint border-line' : ''}`}
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-1.5 md:gap-x-3">
                                ...
                                <div className="flex items-center gap-1">
                                    <input
                                        ...
                                        type="file"
                                        name="cvfile"
                                        className="text-xs md:text-sm w-full md:max-w-56 bg-surface-field border border-line-strong rounded-lg py-1 px-2 h-8 md:h-9"
                                    />
