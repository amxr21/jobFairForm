...
const ProgressSection = ({ status, missing }) => {
    ...
    return (
        <div className="relative overflow-hidden flex flex-col gap-4 md:gap-8 md:w-3/12 border py-6 px-8 md:py-10 md:px-12 h-[28rem] md:h-full bg-[#2959A6] rounded-t-[2.75em] rounded-b-2xl md:rounded-l-[4em] md:rounded-r-3xl">

            
            <GridLeft mark={false} otherClasses={'left-10 -top-40 w-full opacity-30 rotate-90'} />
