...
const ProgressSection = ({ status, missing, currentStep }) => {

    const header = useRef()

    return (
        <div className="relative flex flex-col gap-4 md:gap-8 w-full border py-6 px-8 md:py-10 md:px-12 min-h-[10rem] md:min-h-[28rem] h-fit md:h-full bg-[#2959A6] rounded-t-[2.75em] rounded-b-2xl md:rounded-l-[4em] md:rounded-r-3xl overflow-hidden">
