      ...
      case 'LinkedIn URL':
        return (
          <div className={`flex flex-col grow mb-4 md:my-0 ${fieldClasses} max-w-full`}>
              ...
              <input ref={refLabel} onChange={getInput} type={type} name={name} className="min-h-8 w-full bg-transparent border border-gray-700 rounded-lg py-1.5 px-2 " placeholder={'linkedin.com/in/profile name'} />
          </div>
      )
